/** Ответы для Spotify Store (Spotify Premium) — те же кнопки, что OPERATOR_CHAT_QUICK_REPLIES */
const SUBS_FAQ_OVERRIDES: Record<string, string> = {
  ...
  "Какие способы оплаты?":
    "Оплата картой банка РФ и через СБП на странице оформления заказа Spotify Store.",
  "Как связаться с поддержкой?":
    "Вы уже в чате поддержки Spotify Store. Можно также написать в Telegram: @subs_support (если указан на сайте). Оператор подключится при необходимости.",
  "Можно ли оплатить картой РФ?":
    "Да. Оплата картой банка РФ и через СБП доступна на странице оформления заказа Spotify Store.",
};
...
const FAQ_SCRIPTED_ANSWERS: Record<string, string> = {
  ...
  "Какие способы оплаты?":
    "Оплата картой РФ или СБП. На странице оплаты вы перейдёте к выбору конкретного способа.",
