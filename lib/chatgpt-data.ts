...
export const HERO_CONTENT: HeroContent = {
  ...
  subtitle:
    "Подключаем подписку ChatGPT на ваш аккаунт или поможем с готовым персональным аккаунтом. В большинстве случаев пароль не требуется — при необходимости специалист подскажет безопасный способ подтвердить вход по понятной инструкции.",
  ...
  meta: "Уже 5 000+ подключений · Средний рейтинг 4.9/5",
};
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description:
      "После оплаты специалист в чате сайта уточнит нужные данные. В большинстве случаев пароль не требуется — если аккаунт создан через Google, подскажем безопасный вариант подтверждения.",
    icon: "mail",
  },
  {
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Для подключения на ваш аккаунт может потребоваться передать данные сессии по инструкции. В большинстве случаев пароль не требуется — если аккаунт создан через Google, специалист предложит безопасный вариант: подтвердить вход кодом или установить отдельный пароль ChatGPT по инструкции. Данные отправляются только в официальный чат сайта GPT STORE. Если вы предпочитаете не передавать данные аккаунта, можно выбрать вариант с готовым персональным аккаунтом.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Токен или данные сессии нужны, чтобы мы могли выполнить подключение подписки на аккаунт ChatGPT. Важно понимать: такие данные могут предоставлять доступ к аккаунту, поэтому отправляйте их только в официальный чат сайта GPT STORE. В большинстве случаев пароль не требуется. Если аккаунт создан через Google, специалист предложит безопасный вариант подтверждения. После подключения вы можете завершить активные сессии или обновить настройки безопасности аккаунта.",
  },
  {
