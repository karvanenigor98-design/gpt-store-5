...
/** Скрыт из публичной витрины по умолчанию (plan_availability / inStock). Не удалять — нужен для админки и старых заказов. */
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Да. Для подключения или продления на вашем текущем аккаунте выбирайте «Популярный» или «Быстрая активация». Если нужен уже готовый аккаунт с активированным Plus — тариф «Готовый аккаунт ChatGPT Plus».",
  },
  {
