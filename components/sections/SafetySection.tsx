      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="font-heading text-3xl font-bold text-gray-900 md:text-4xl">
            Подключение проходит по понятной инструкции, без лишних действий с вашей стороны
          </h2>
          <p className="max-w-2xl text-lg text-gray-700">
            В большинстве случаев пароль не нужен. Если для вашего аккаунта потребуется подтверждение — специалист
            объяснит безопасно и понятно. Оплата в рублях, статус заказа виден в кабинете.
          </p>
        </motion.div>
