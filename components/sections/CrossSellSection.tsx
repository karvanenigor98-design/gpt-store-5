...
/** Баннер SPOTIFY STORE на лендинге GPT STORE — отдельная секция перед финальным CTA. */
export function CrossSellSection() {
  const subsHref = getCrossStoreLandingHref("subs-store");
    ...
    <section id="projects" className="px-4 py-12 md:px-6 md:py-16">
      <div className="mx-auto max-w-4xl">
        <motion.div
          ...
          variants={fadeUp}
          className="flex w-full flex-col items-start justify-between gap-5 rounded-2xl border border-black/[0.08] bg-gray-50 p-5 text-left sm:flex-row sm:items-center sm:p-6"
        >
