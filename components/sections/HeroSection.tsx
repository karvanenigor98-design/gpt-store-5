...
import { HERO_CONTENT, HERO_ACCENT_BASE, HERO_ACCENT_WITH_TIMING, HERO_BADGE_NO_TIMING, HERO_BADGE_WITH_TIMING } from "@/lib/chatgpt-data";
        ...
        <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-start gap-6 md:grid-cols-2 md:items-center md:gap-8">
          ...
          >
            <motion.div
              ...
              className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#10a37f]/20 bg-[#10a37f]/[0.07] px-4 py-2 text-sm text-[#10a37f] md:mb-6"
            >
            ...
            >
              <span className="block text-3xl md:text-5xl lg:text-6xl">{HERO_CONTENT.title}</span>
              <span
            ...
            <motion.p
              ...
              className="mt-4 max-w-xl text-sm text-gray-500 md:mx-0 md:mt-5 md:text-lg"
            >
            ...
            <motion.div
              ...
              className="mt-7 hidden w-full flex-col items-center gap-3 md:flex md:items-start sm:w-auto sm:flex-row sm:gap-4"
            >
              <motion.a
                href="#pricing"
                onClick={(e) => {
            ...
            <motion.p
              ...
              className="mt-3 hidden text-xs text-gray-400 sm:block md:mt-4 md:text-sm"
            >
              {HERO_CONTENT.meta}
            </motion.p>
          </motion.div>
